...
@click.option(
    "--pkl",
    default=None,
    help="Path to network-snapshot-*.pkl; defaults to latest for $DV_DATASET_NAME",
)
@click.option(
    "--kind",
    "dataset_kind",
    default="stills",
    type=click.Choice(["stills", "frames"]),
    show_default=True,
)
...
@click.option(
    "--walks-dir", default=None, help="Override; default = <unscoped DV_WALKS_DIR>/<id>"
)
def main(
    model_id: str,
    pkl,
