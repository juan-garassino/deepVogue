...
def calc_metric(
    ...
    return neuronal_network_utils.EasyDict(
        results=neuronal_network_utils.EasyDict(results),
        metric=metric,
        total_time=total_time,
        total_time_str=neuronal_network_utils.util.format_time(total_time),
